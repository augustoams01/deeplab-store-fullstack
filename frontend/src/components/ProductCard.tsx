    ...
    <div className="w-[380px] rounded-3xl p-6 flex flex-col items-center">
      ...
      <div className='flex gap-5'>
        ...
        <div className="mt-6 flex items-center ">
          ...
          <span className="text-white border-t border-b border-b-gray-300/20 border-t-gray-300/20  bg-white/10 h-[80%] text-lg flex items-center z-50">
            {quantity}
          </span>
        ...
        <button className="mt-6 py-3 px-4 rounded-full bg-transparent border border-primary text-gray-300 hover:scale-[1.02] transition">
